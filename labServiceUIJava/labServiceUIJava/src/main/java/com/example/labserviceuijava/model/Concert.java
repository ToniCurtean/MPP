package com.example.labserviceuijava.model;
...
public class Concert extends Entity<Integer>{
    ...
    public Concert(Integer integer, String concertDate, String concertLocation, Integer ticketsAvailable, Integer ticketsSold, Integer artistId,String startingTime) {
        super(integer);
