namespace model
{
    public class Concert : Entity<int>
    {
        ...
        public Concert(int id) : base(id)
        {
        }

        public Concert(int id, string date, string concertLocation, int ticketsAvailable, int ticketsSold, int artistId,
            string startTime) : base(id)
        {
            this.date = date;
